...
/// Un diálogo que se muestra cuando se intenta acceder a una función exclusiva para usuarios Premium.
class PremiumFeatureDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
        width: screenSize.width * 0.95, // Increased width for larger dialog
          ...
          child: Stack(
            children: [
              ...
              SingleChildScrollView(
                child: Padding(
                  padding:
                      const EdgeInsets.all(30), // Slightly increased padding
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Para descargar tu plan en PDF y disfrutar de todos los beneficios, necesitas una cuenta Premium.',
                        textAlign: TextAlign.center,
                        style: GoogleFonts.lato(
                          fontSize: 16,
                          color: FrutiaColors.secondaryText,
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () =>
                      Navigator.of(context).pop(), // Esta línea es correcta
                  child: Container(
